  ...
  return (
    <aside className="w-[15rem] bg-white shadow-lg flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-auto">
        ...
        {/* Separator */}
        <hr className="my-4 border-t border-gray-300" /> {/* Added separator here */}

        {/* Projects Section */}
        <div className="mt-10">
          <h3 className="text-sm font-semibold text-gray-500 mb-2">Asana Projects</h3>
          <div className="space-y-1">
            {projects.length === 0 ? (
              ...
              projects.map((p) => (
                ...
                >
                  <Folder
                    className={`w-6 h-6 mr-2 ${selectedProject === p.gid ? "text-white" : "text-green-500"} flex-shrink-0`}
                  />
